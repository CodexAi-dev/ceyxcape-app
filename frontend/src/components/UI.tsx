...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    ...
    outline: 'border-2 border-primary text-primary hover:bg-primary hover:text-white disabled:border-gray-400',
  };
...
export const Badge: React.FC<{
  ...
  return (
    <span className={`px-2 py-1 text-sm font-semibold rounded-full ${variantStyles[variant]} ${className}`}>
      {children}
    </span>
  );
};
...
export const Alert: React.FC<{
  ...
  return (
    <div className={`p-4 rounded-lg border-l-4 flex items-start gap-3 ${typeStyles[type]} ${className}`}>
