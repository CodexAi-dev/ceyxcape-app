-- CeyXcape MySQL Schema — cPanel version
-- USAGE: In phpMyAdmin, FIRST click your database (ceyxcape_ceyxcape_new)
-- in the left sidebar, THEN go to Import and upload THIS file.
-- (No CREATE DATABASE / USE here — cPanel users can't create databases via SQL.)
